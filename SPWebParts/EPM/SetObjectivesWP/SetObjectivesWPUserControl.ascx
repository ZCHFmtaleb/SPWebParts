...
<table class="Form_Table_css">
    <tr>
        <td class="auto-style1">اسم الهدف</td>
        <td class="auto-style1"><asp:TextBox ID="txtObjName" runat="server" MaxLength="255" Width="500px" ValidationGroup="vg1"></asp:TextBox>
